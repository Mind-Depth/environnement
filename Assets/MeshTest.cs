...
public class MeshTest : MonoBehaviour
{
    ...
    private static Mesh DestructionTriangle(Mesh obj, int i)
    {
    ...
    private static Mesh DestructionMesh(Mesh obj, Vector3 anchorPoint, Vector3 normalDirection)
    {
